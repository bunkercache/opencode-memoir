...
A smart memory management plugin that supports nested aggregation of memory, summaries, and file changes that compact in layers with upstream references for lookups.
...
Chris Tunbridge <967304+Destreyf@users.noreply.github.com>

## Repository

https://github.com/bunkercache/memoir
